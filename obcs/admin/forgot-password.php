...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT UserName FROM tbladmin WHERE UserName=:uname";
...
<body class="materialdesign">
    ...
    <div class="wrapper-pro">
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                               <h3 style="font-weight: bold;color: blue">Barangay 60</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
     ...
     <option value="" selected="true">Security Question</option>
     ...
     <option value="What is your favorite hobby?">What is your favorite hobby?</option>
          ...
          <option value="What is the name of your teacher in 6th grade?">What is the name of your teacher in 6th grade?</option>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="text" name="mobile"  placeholder="Security Answer" required="true">
