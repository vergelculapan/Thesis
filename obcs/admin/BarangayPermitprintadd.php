...
if (mysqli_query($dbh,$sql)) {
           echo '<script>alert("Barangay Business Permit has been ready to print")</script>';
         echo "<script>window.location.href ='BarangayPermitprinttable.php'</script>";
...
{               ?> 
  ...
  <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Operator</label>
                                                                </div>
                                                                </div>
                                                        </div>
                                                           <div class="form-group-inner">
                                                        ...
                                                        <div class="form-group-inner">
                                                          ...
                                                          <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <Input type="text" class="form-control" name="Certificate"  value="Barangay Business Permit" required="true" readonly="true"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                           ...
                                                           <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <textarea type="text" class="form-control" required="true" value="" name="Purpose" /></textarea> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                          ...
                                                          <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Business Name/Trade Activity</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <textarea type="text" class="form-control" required="true" value="" name="Issfrm" /></textarea> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                          ...
                                                          <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <textarea type="text" class="form-control" required="true" value="" name="Issat" /></textarea> 
                                                                </div>
                                                            </div>
                                                        </div>
