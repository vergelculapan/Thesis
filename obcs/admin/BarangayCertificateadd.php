...
if (mysqli_query($dbh,$sql)) {
         ...
         echo "<script>window.location.href ='BarangayCertificatetable.php'</script>";
                                                        ...
                                                        <div class="form-group-inner">
                                                          ...
                                                          <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <Input type="text" class="form-control" name="Certificate"  value="Barangay Certificate" required="true" readonly="true"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                          ...
                                                          <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Issued For</label>
                                                                </div>
                                                                <div class="col-lg-9">
