...
{               ?>
                                                        ...
                                                        <div class="form-group-inner">
                                                         ...
                                                         <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Security Question</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                     <select name="email" class="form-control wd-450" required="true" >
     <option value="<?php  echo $row->Email;?>" selected="true"><?php  echo $row->Email;?></option>
     ...
     <option value="What is your favorite hobby?">What is your favorite hobby?</option>
          ...
          <option value="What is the name of your teacher in 6th grade?">What is the name of your teacher in 6th grade?</option>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Security Answer</label>
                                                                </div>
                                                                <div class="col-lg-9">
