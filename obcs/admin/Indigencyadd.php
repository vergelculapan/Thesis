...
if (mysqli_query($dbh,$sql)) {
           echo '<script>alert("Barangay Indigency has been ready to print")</script>';
         echo "<script>window.location.href ='Indigencytable.php'</script>";
                                                        ...
                                                        <div class="form-group-inner">
                                                          ...
                                                          <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <Input type="text" class="form-control" name="Certificate"  value="Barangay Indigency" required="true" readonly="true"/>
                                                                </div>
                                                            </div>
                                                        </div>
