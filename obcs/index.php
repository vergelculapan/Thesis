...
<head>
    ...
    <title>Home Page - Barangay 60 Letsugas</title>
...
<body>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php">Barangay 60</a>
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(Barangay60.jpg);">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Barangay60
